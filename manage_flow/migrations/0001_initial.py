    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('app_name', models.CharField(blank=True, max_length=10, null=True, verbose_name='app name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='manage_flow.Modal', verbose_name='workflow model')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inst', models.ForeignKey(on_delete=None, to='manage_flow.Instance', verbose_name='workflow instance')),
                ('node', models.ForeignKey(blank=True, null=True, on_delete=None, to='manage_flow.Node', verbose_name='current node')),
                ('user', models.ForeignKey(on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='handler')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='instance',
            name='modal',
            field=models.ForeignKey(on_delete=None, to='manage_flow.Modal', verbose_name='workflow model'),
        ),
        migrations.AddField(
            model_name='instance',
            name='starter',
            field=models.ForeignKey(on_delete=None, related_name='starter', to=settings.AUTH_USER_MODEL, verbose_name='start user'),
        ),
        migrations.CreateModel(
            name='History',
            fields=[
                ...
                ('inst', models.ForeignKey(on_delete=None, to='manage_flow.Instance', verbose_name='workflow instance')),
                ('node', models.ForeignKey(blank=True, null=True, on_delete=None, to='manage_flow.Node', verbose_name='workflow node')),
                ('user', models.ForeignKey(on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='submitter')),
            ],
            options={
